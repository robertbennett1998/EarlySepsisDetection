...
ON sp.subject_id = le.subject_id AND    (le.itemid = '51301' OR -- white blood cells
                                         le.itemid = '51144' --Bands (immature white blood cells - indicate an inflamatory response - 3-5% is normal) 
                                        )
